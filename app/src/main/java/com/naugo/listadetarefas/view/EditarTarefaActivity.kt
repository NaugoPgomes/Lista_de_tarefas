...
import com.naugo.listadetarefas.viewModel.EditarTarefaViewModel
import kotlinx.android.synthetic.main.activity_cadastro_tarefa.*
import java.text.SimpleDateFormat
import java.util.*

class EditarTarefaActivity : AppCompatActivity(), View.OnClickListener, DatePickerDialog.OnDateSetListener{

    private lateinit var mViewModel: EditarTarefaViewModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mViewModel = ViewModelProvider(this).get(EditarTarefaViewModel::class.java)
    ...
    private fun observe() {
        mViewModel.SalvarFormulario.observe(this, androidx.lifecycle.Observer
        {
            if (it) {
            } else {
        ...
        mViewModel.guest.observe(this, androidx.lifecycle.Observer {
